-- Script de Dados Sintéticos para Popular o Banco de Dados
-- Sistema de Recomendação LightFM
-- Ordem de inserção respeitando dependências de FK

-- 1. Tabelas Independentes

-- Popula a tabela Universidades
...
-- Popula a tabela Categorias_Estabelecimentos
...
-- Popula a tabela Usuarios (depende de Universidades)
...
-- Popula a tabela Estabelecimentos (depende de Categorias_Estabelecimentos)
...
-- Popula a tabela Usuario_Preferencia (ligando Usuarios e Preferencias)
...
-- Popula a tabela Estabelecimento_Preferencia (ligando Estabelecimentos e Preferencias)
...
-- Popula a tabela Recomendacao_Usuario (Recomendações entre usuários)
...
-- Popula a tabela Recomendacao_Estabelecimento (Recomendações/Avaliações de lugares por usuários)
